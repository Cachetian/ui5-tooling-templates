sap.ui.require([
    ...
    Opa5.createPageObjects({
        onTheMainPage: {
            viewName: "custom.bookshop.bookshop.view.MainView",
            ...
            assertions: {
                ...
                iShouldSeeTheTitle: function () {
                    return this.waitFor({
                        ...
                        properties: {
                            text: "Title of custom.bookshop.bookshop"
                        },
                        success: function() {
                            Opa5.assert.ok(true, "The page shows the correct title");
                        },
                        errorMessage: "App does not show the expected title custom.bookshop.bookshop"
                    });
                }
            }
